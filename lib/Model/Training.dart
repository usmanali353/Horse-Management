...
class Training {
  String horse_name,trainer_name,training_type,training_center,start_date,end_date,target_date,excercise_plan;
  ...
  Training(this.horse_name, this.trainer_name, this.training_type,
      ...
      this.training_type_id, this.excercise_plan_id);
  ...
  Training.fromMap(Map<String,dynamic> data){
    id=data['id'];
