...
class update_opertation_note extends StatefulWidget{
  final token;
  var specificnote;
  update_opertation_note(this.token, this.specificnote);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _update_opertation_note(token,specificnote);
  }

}
class _update_opertation_note extends State<update_opertation_note>{
  final token;
  var specificnote;
  _update_opertation_note(this.token,this.specificnote);
