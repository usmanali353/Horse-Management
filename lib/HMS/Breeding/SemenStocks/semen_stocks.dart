...
//                if(response!=null){
//                  setState(() {
//                    semen_stock_list.decode(response);
//                    isVisible=true;
//                  });
//
//                }else{
...
//                        caption: 'Hide',
//                        onTap: () async {
//                          SemenStockServices.change_semen_dose_visibility(token, semen_stock_list[index]['breedingServiceId']).then((response){
//                            print(response);
//                            if(response!=null){
//                              Scaffold.of(context).showSnackBar(SnackBar(
...
//                      subtitle: Text(semen_stock_list!=null?semen_stock_list[index]['sireName']['name']:''),
