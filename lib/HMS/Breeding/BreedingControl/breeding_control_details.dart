              ...
              Column(
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    trailing: Text(breeding_control_data['relatedServiceDate']['serviceDate'].toString()!=null?breeding_control_data['relatedServiceDate']['serviceDate'].toString().substring(0,10):''),
                  ),
                  ListTile(
                    title: Text("LO:"),
