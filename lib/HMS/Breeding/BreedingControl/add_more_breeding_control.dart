...
//                      child: add_breeding_control_button(breeding_control_list:breeding_control_list,volvoplasty:Volvoplasty,reabsorption: Reabsorption,twins: Twins,ovule: Ovule,follicle:Follicle,pregnancy:Pregnancy,empty:empty,abortion:Abortion,token: token,fbKey: _fbKey, contactId: contact_id, selected_account_category: account_category_id,seleced_vet_id: vet_id,selected_check_method_id: selected_check_method_id,selected_related_services_id: selected_related_services_id,selected_horse_id: selected_horse_id,selected_costcenter_id: selected_costcenter_id,selected_contact_id: selected_contact_id,selected_currency_id: selected_currency_id,selected_currency: selected_currency,selected_horse: selected_horse,selected_costcenter: selected_costcenter,selected_related_services: selected_related_services,selected_account_category_id: selected_account_category_id,selected_check_method: selected_check_method,selected_vet:selected_vet,comments: comments,uterus: uterus,date: date,hour:hour,vagina: vagina,cervix: cervix, amount: amounts,lo: lo,ro: ro,)
...
//  final String amount,comments, token,selected_contact,selected_costcenter,selected_account_category,selected_currency,selected_horse,selected_check_method,selected_vet,selected_related_services;
...
//  final TextEditingController lo,ro,uterus,vagina,cervix;
//  @override
//  Widget build(BuildContext context) {
//    return Center(
//      child: Padding(
