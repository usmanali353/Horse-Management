          ...
          onPressed: (){
            ...
            if(_fbKey.currentState.validate()){
             ...
             // network_operations.add_breeding_control(token, breeding_control_data['breedingControlId'], breeding_control_list['horseDropDown'][selected_horse_id]['id'], date,hour, selected_check_method_id, breeding_control_list['relatedServiceDropDown'][selected_related_services_id]['id'], empty, pregnancy, abortion, reabsorption, follicle, ovule, twins, volvoplasty,double.parse(amount.text), breeding_control_list['currencyDropDown'][selected_currency_id]['id'],breeding_control_data['createdBy'], comments.text, lo.text, ro.text, uterus.text, vagina.text, cervix.text, breeding_control_list['categoryDropDown'][selected_account_category_id]['id'], breeding_control_list['costCenterDropDown'][selected_costcenter_id]['id'], breeding_control_list['contactsDropDown'][selected_contact_id]['id'],breeding_control_list['vetDropDown'][seleced_vet_id]['id'], true)
              network_operations .add_breeding_control(token: token,id: breeding_control_data['breedingControlId'],horseId: breeding_control_list['horseDropDown'][selected_horse_id]['id'],date: DateTime.now(),check_method_id: selected_check_method_id,serviceid: breeding_control_list['relatedServiceDropDown'][selected_related_services_id]['id'],empty: empty,pregnancy: pregnancy,abortion: abortion,reabsorption: reabsorption,follicle: follicle,ovule: ovule,twins: twins,volvoplasty: volvoplasty,amount: double.parse(amount.text),currencyid: breeding_control_list['currencyDropDown'][selected_currency_id]['id'],Createdby: breeding_control_data['createdBy'],comments: comments.text,lo: lo.text,ro: ro.text,uterus: uterus.text,vagina: vagina.text,cervix: cervix.text,accountcategory:  breeding_control_list['categoryDropDown'][selected_account_category_id]['id'],costcenterid: breeding_control_list['costCenterDropDown'][selected_costcenter_id]['id'],contactid: breeding_control_list['contactsDropDown'][selected_contact_id]['id'],vetId: breeding_control_list['vetDropDown'][seleced_vet_id]['id'],nextcheck: null,hour: null)
                  .then((response){
                if(response!=null){
