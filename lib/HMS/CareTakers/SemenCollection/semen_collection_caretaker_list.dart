  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        SemenCollectionCareTakerServices.semenCollection_caretaker_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
          if(response!=null){
            setState(() {
                    ...
                    if(load_list['hasNext'] == true && pagenum >= 1 ) {
                      Utils.check_connectivity().then((result){
                        if(result) {
                          ProgressDialog pd = ProgressDialog(context, isDismissible: true, type: ProgressDialogType.Normal);
                          pd.show();
                          SemenCollectionCareTakerServices.semenCollection_caretaker_by_page(
...
//                            },
                          ...
                          ListTile(
                            ...
                            title: Text(siemen_col_list!=null?siemen_col_list[index]['horseName']['name']:''),
                             ...
                             trailing:Text(siemen_col_list!=null?"Status: "+(get_status_by_id(siemen_col_list[index]['status'])).toString():'empty'),
    ...
    return new InkWell(
      ...
      child: new Padding(
        ...
        child: new Column(
          ...
          children: <Widget>[
            const Text('Semen Collection Caretaker'),
          ],
        ),
      ),
    );
