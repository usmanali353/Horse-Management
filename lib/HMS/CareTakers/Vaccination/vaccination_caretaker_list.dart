  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        VaccinationCareTakerServices.vaccination_caretaker_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
          if(response!=null){
            setState(() {
...
//                                  });
                      ...
                      child: ListTile(
                        ...
                        trailing:Text(vaccinationlist!=null?"Status: "+(get_status_by_id(vaccinationlist[index]['status'])).toString():'empty'),
    ...
    return new InkWell(
      ...
      child: new Padding(
        ...
        child: new Column(
          ...
          children: <Widget>[
            const Text('Vaccination Caretaker'),
          ],
        ),
      ),
    );
