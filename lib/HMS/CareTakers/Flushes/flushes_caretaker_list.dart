  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        FlushesCareTakerServices.flushes_caretaker_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
          if(response!=null){
            setState(() {
                      ...
                      child: FadeAnimation(2.0,
                         ListTile(
                          ...
                          subtitle: Text(flushes_list!=null?flushes_list[index]['vetName']['contactName']['name']:''),
                           trailing:Text(flushes_list!=null?"Status: "+(get_status_by_id(flushes_list[index]['status'])).toString():'empty'),
