        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              add_note_button(token: token,description: details ,date: date,selected_horse: selected_horse,selected_horse_id: selected_horse_id,notes_data: notes_data,fbKey: _fbKey,)
            ],
          )
        ],
      )
