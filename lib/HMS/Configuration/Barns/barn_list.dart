...
import 'package:horse_management/HMS/Configuration/Barns/barn_details.dart';
...
class _barn_list extends State<barn_list>{
  ...
  var _isSearching=false, isPagination=false, searchLoadList=null;
  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        BarnServices.barn_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
                  ...
                  Slidable(
                      ...
                      child: FadeAnimation(2.0,
                        ListTile(
                          ...
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>barn_details_page(barn_lists[index])));
                          },
                        ),
                      )
                  ),
        ...
        child: InkWell(child: Icon(Icons.add),
            onTap: () =>
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => add_barn(token)),)
