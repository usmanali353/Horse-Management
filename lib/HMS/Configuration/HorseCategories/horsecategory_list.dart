...
import 'package:horse_management/HMS/Configuration/HorseCategories/horseCategories_details.dart';
  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        HorseCategoryServices.horseCategories_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
                    ...
                    if(load_list['hasNext'] == true && pagenum >= 1 ) {
                      Utils.check_connectivity().then((result){
                        if(result) {
                          ProgressDialog pd = ProgressDialog(context, isDismissible: true, type: ProgressDialogType.Normal);
                          pd.show();
                          HorseCategoryServices.horseCategories_by_page(
                  ...
                  Slidable(
                      ...
                      child: FadeAnimation(2.0,
                         ListTile(
                          ...
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>horseCategories_details_page(category_lists[index])));
                          },
                        ),
                      )
                  ),
        ...
        child: InkWell(child: Icon(Icons.add),
            onTap: () =>
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => add_horsecategory(token)),)
