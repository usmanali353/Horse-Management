  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        CostCenterServices.costCenters_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
        ...
        CostCenterServices.costCenters_by_page(token,pagenum,searchQuery).then((response){
          ...
          if(response!=null){
            setState(() {
              ...
              if(costcenter_lists!=null){
               costcenter_lists.clear();
              }
              load_list=json.decode(response);
              costcenter_lists = load_list['response'];
              total_page=load_list['totalPages'];
        ...
        child: InkWell(child: Icon(Icons.add),
            onTap: () =>
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => add_costcenter(token)),)
