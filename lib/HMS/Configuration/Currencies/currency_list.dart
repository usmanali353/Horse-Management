  ...
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        CurrenciesServices.currencies_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
        ...
        CurrenciesServices.currencies_by_page(token,pagenum,searchQuery).then((response){
          ...
          if(response!=null){
            setState(() {
              ...
              if(currency_lists!=null){
                currency_lists.clear();
              }
              load_list=json.decode(response);
              currency_lists = load_list['response'];
              total_page=load_list['totalPages'];
        ...
        child: InkWell(child: Icon(Icons.add),
            onTap: () =>
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => add_currency(token)),)
