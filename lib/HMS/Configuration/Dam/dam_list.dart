...
class _dam_list extends State<dam_list>{
  ...
  var dam_lists, load_list, pagelist, pageloadlist;
  int pagenum = 1;
  int total_page;
  @override
  void initState() {
    ...
    Utils.check_connectivity().then((result){
      if(result) {
        ...
        pd.show();
        DamServices.dam_by_page(token, pagenum, searchQuery).then((response){
          pd.dismiss();
