              ...
              child: MaterialButton(
                onPressed: () async{
                  ...
                  if(_fbKey.currentState.validate()){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>addProductsApplied(prefs.getString("token"),date,selected_horse_id,selected_vet_id,selected_opinion_id,confirmationDropdowns['vetVisitProduct']['inventoryProductsDropDown'])));
                  }
                },
